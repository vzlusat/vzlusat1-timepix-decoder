...
IMAGES_PATH="$MRS_SINGULARITY_PATH/singularity/images"
OVERLAYS_PATH="$MRS_SINGULARITY_PATH/singularity/overlays"
MOUNT_PATH="$MRS_SINGULARITY_PATH/singularity/mount"

## | ----------------------- user config ---------------------- |

# use <file>.sif for normal container
# use <folder>/ for sandbox container
CONTAINER_NAME="vzlusat.sif"
OVERLAY_NAME="vzlusat.img"
...
MOUNTS=(
  ...
  "type=bind" "$MRS_SINGULARITY_PATH" "$HOME/vzlusat1-timepix-decoder"
